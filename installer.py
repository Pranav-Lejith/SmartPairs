...
def main():
    ...
    # Step 1: Find IDLE path automatically
    try:
        import idlelib
    ...
    # Step 2: Write exact uncorrupted script
    try:
        ...
        print("Please close this window, right-click 'setup_ampxd.py', and select 'Run as Administrator'.")
        input("\nPress Enter to exit...")
        return

    # Step 3: Append configuration safely
